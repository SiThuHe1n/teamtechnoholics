...
{
$query="SELECT * FROM ideas WHERE categoryID=$catego AND ideaTitle LIKE '%%%$tit%%%' AND userID='$userID'";
$query1="SELECT * FROM ideas WHERE categoryID=$catego AND ideaTitle LIKE '%%%$tit%%%' AND userID='$userID'";
}

ElseIF($_GET['Page'] && $_GET['search']!="" && $_GET['filter']=="mostviewed" && $_GET['category']!="ALL" )
{
   
    $query=" SELECT * FROM ideas WHERE ideaTitle LIKE '%%%$tit%%%' AND categoryID=$catego AND userID='$userID' order by viewCount desc limit 5 ";
      $query1="  SELECT * FROM ideas WHERE ideaTitle LIKE '%%%$tit%%%' AND categoryID=$catego AND userID='$userID' order by viewCount desc limit 5 ";
}
