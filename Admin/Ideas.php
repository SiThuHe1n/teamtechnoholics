...
<html lang="en">
  ...
  <body>
      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-light">
          <ul class="navbar-nav">
            ...
            <li>
              <a href="Ideas.php" class="nav-link px-3 text-primary">
                <span class="me-2">
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="bg-light border border-dark p-3 mt-3 shadow">
          <div class="row mt-3">
            <div class="col-md-12">
              <div class="card">
 ...
 $cat="SELECT * FROM categories order by categoryID";
  ...
  else
  {
    ...
    ></script>
    <script
      src="https://cdn.tiny.cloud/1/rrr9ywwcmgivj2altdsyamur2wt6sdp2g5r2x29uu63s33g9/tinymce/5/tinymce.min.js"
