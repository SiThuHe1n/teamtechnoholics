...
if(isset($_POST['cdepartmentName'])  )
{
  $cdepartmentName=$_POST['cdepartmentName'];

  $query="INSERT INTO department (departmentName) VALUES ('$cdepartmentName')";
...
<html lang="en">
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        ...
        <nav class="navbar-light">
          <ul class="navbar-nav">
            ...
            <li>
             ...
             <li>
              <a href="department.php" class="nav-link px-3 text-primary ">
                <span class="me-2">
                  <i class="fa-solid fa-user-group"></i>
                </span>
                Department
        ...
        <div class="row">
          <div class="col mx-3">
            <div class="row mb-2 pb-3">
              <div class="col-xs-8">
                <h2 class="h3 page-header">Department </h2>
              </div>
            </div>
            <hr class="dropdown-divider" />
            <div class="card rounded-0 mt-3">
              <div class="card-header p-2 mb-3">
                <h5 class="card-title font-weight-bold"> All Department </h5>
              </div>
              <div class="card-body">
                <form action="">
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-0">
          ...
          <div class="modal-body">
              ...
              <div class="form-group mb-3">
                <label for="cdepartmentName">Department Name:</label>
                <input
                  type="text"
                  name="cdepartmentName"
                   id="cdepartmentName"
                  class="form-control"
                  required
                />
    ...
    <div
      class="modal fade"
      id="editModal<?php echo $arr1['departmentID']; ?>"
      tabindex="-1"
          ...
          <div class="modal-body">
              ...
              <div class="form-group mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="uDepartmentName"
                  id="uDepartmentName<?php echo $arr1['departmentID']; ?>"
                  value="<?php echo $arr1['departmentName']; ?>"
                />
              </div>
              ...
              <div class="mt-4 text-center">
                ...
                <button   data-bs-dismiss="modal" id="Update<?php echo $arr1['departmentID']; ?>" class="btn btn-dark btn btn-sm rounded-0">
                  Update Data
                </button>
              </div>
    ...
    <div
      class="modal fade"
      id="deleteConfirmModal<?php echo $arr1['departmentID']; ?>"
      tabindex="-1"
            ...
            <div class="mx-auto text-center">
              ...
              >
                Cancel
                 ...
                 <button
              id="Delete<?php echo $arr1['departmentID']; ?>"
...
$(document).ready(function(){
  Show();
  $("#Delete<?php echo $arr1['departmentID']; ?>").click(function() {
                var id=<?php echo $arr1['departmentID']; ?>;
  ...
  $("#Update<?php echo $arr1['departmentID']; ?>").click(function() {
                var id=<?php echo $arr1['departmentID']; ?>;
                var departmentName=$('#uDepartmentName<?php echo $arr1['departmentID']; ?>').val();
